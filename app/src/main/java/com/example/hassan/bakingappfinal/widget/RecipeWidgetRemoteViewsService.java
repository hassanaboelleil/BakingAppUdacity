package com.example.hassan.bakingappfinal.widget;
    ...
    public RemoteViewsFactory onGetViewFactory(Intent intent) {
        return new RemoteViewsFactory() {
            ...
            public RemoteViews getViewAt(int position) {
                ...
                views.setTextViewText(R.id.textview_ingredient, data.getString(INDEX_INGREDIENT_NAME));
                views.setTextViewText(R.id.textview_measure, data.getString(INDEX_INGREDIENT_MEASURE));
                views.setTextViewText(R.id.textview_quantity, String.valueOf(data.getInt(INDEX_INGREDIENT_QUANTITY)));
